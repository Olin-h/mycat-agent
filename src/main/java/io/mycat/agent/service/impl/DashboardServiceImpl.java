...
import io.mycat.agent.mapper.MysqlStatusHistoryMapper;
import io.mycat.agent.service.DashboardService;
import io.mycat.agent.util.MiscUtil;
import io.mycat.agent.util.SysSampleUtil;
...
public class DashboardServiceImpl extends AbstractService implements DashboardService {
    ...
    private DashboardOverview getQpsChatData(DashboardOverview dashboardOverview, Long serverId) {
        ...
        //获取30分钟的数据
        criteria.andCreateTimeBetween(DateUtils.addMinutes(new Date(), -180), new Date());
